...
class Engine:
    ...
    def get_string(self, string):
        ...
        string_ = language_string.get(lang_).get(string) or f"**404_STRING_NOT_FOUND :** `String {string} Not Found in {lang} String 	File. - Please Report It To @TezerChat`"        return string_
